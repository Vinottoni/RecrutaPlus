    ...
    public class AppDbContext :DbContext, IUnitOfWork
    {
        ...
        public class AppDbContextFactory : IDesignTimeDbContextFactory<AppDbContext>
        {
            public AppDbContext CreateDbContext(string[] args)
            {
                ...
                optionBuilder.UseMySql("server=localhost;Port=3306;User Id=root;password=123456;Persist Security Info=True;database=recrutamais", ServerVersion.AutoDetect("server=localhost;Port=3306;User Id=root;password=123456;Persist Security Info=True;database=recrutamais"));
